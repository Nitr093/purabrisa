/* ─────────────────────────────────────────────
   ...
   • Agregados íconos de redes (Instagram, FB, LinkedIn) en Contacto
...
function FacebookIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3.6l1-4h-4.6V7a1 1 0 0 1 1-1h3z" />
    </svg>
  );
}
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 sm:grid-cols-3">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2.5 text-sm text-paper/80">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:info@purabrisa.com.ar" className="hover:text-amber transition-colors">
            ...
            {/* Redes Sociales */}
            <li className="mt-4 flex items-center gap-5 pt-3 border-t border-paper/10">
              <a href="https://www.instagram.com/purabrisa.ok/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-paper/80 hover:text-amber transition-colors">
                <InstagramIcon />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61591539720289" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-paper/80 hover:text-amber transition-colors">
                <FacebookIcon />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-paper/80 hover:text-amber transition-colors">
                <LinkedInIcon />
              </a>
            </li>
          </ul>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <a
            ...
            className="mt-1.5 inline-block text-sm font-semibold text-paper hover:text-amber transition-colors"
          >
